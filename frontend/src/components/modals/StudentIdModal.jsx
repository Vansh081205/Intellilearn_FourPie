...
export default function StudentIdModal({ studentId, onClose }) {
      ...
      >
        ...
        <div className="text-center">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-6 rounded-xl mb-6 border-2 border-blue-200 dark:border-blue-800"
          >
          ...
          >
            {copied ? (
              ...
              <>
                <Copy className="w-5 h-5 text-gray-600 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" />
                <span className="text-gray-700 dark:text-gray-200 font-medium">Copy Student ID</span>
              </>
            )}
          </motion.button>
          ...
          <motion.button
            ...
            onClick={onClose}
            className="w-full py-3 px-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg font-semibold hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all"
          >
